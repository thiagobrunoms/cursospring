...
public class DatabaseDevService {
	...
	public void initiateTestDatabase() throws ParseException {
		...
		Category cat2 = new Category(null, "asdfasdf");
		Category cat3 = new Category(null, "asdfasdfo");
		Category cat4 = new Category(null, "asdfasdf");
		Category cat5 = new Category(null, "asdfas");
		Category cat6 = new Category(null, "ghgh e Cia");
		Category cat7 = new Category(null, "kjkjhjg");
		Category cat8 = new Category(null, "dtydg");
